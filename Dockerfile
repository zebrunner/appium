...
RUN export DEBIAN_FRONTEND=noninteractive && apt-get update && apt-get -y install awscli iputils-ping ffmpeg nano jq unzip telnet wget curl libimobiledevice-utils libimobiledevice6 usbmuxd
