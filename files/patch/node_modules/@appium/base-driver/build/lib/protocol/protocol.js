...
function buildHandler(app, method, path, spec, driver, isSessCmd) {
    const asyncHandler = async (req, res) => {
        ...
        try {
            ...
            getLogger(driver, req.params.sessionId).debug(`Calling %s.%s() with args: %s`, driver.constructor.name, spec.command, support_1.logger.markSensitive(lodash_1.default.truncate(JSON.stringify(args), { length: constants_1.MAX_LOG_BODY_LENGTH })));
            ...
            async function updateDevice(token, udid, note, status) {
