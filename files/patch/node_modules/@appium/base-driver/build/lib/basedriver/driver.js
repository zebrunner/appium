...
class BaseDriver extends core_1.DriverCore {
    ...
    driverData) {
        ...
        const logDirName = process.env.LOG_DIR ?? '/tmp/log';
    ...
    async deleteSession(sessionId) {
        ...
        const removeRecordingArtifact = async (fileName) => {
            try {
