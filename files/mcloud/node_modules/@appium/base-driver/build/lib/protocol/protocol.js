    ...
    let asyncHandler = async (req, res) => {
        ...
        try {
            ...
            if (err.message.toLowerCase().includes("cannot find any free port in range")) {
                console.log(`An error occurred: Could not start a new session. This may be due to not being able to find any free port in the specified range or other server-side issues. Appium exit with code 1 `);
