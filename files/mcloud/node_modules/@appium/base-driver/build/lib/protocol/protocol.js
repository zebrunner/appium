    ...
    let asyncHandler = async (req, res) => {
        ...
        try {
            ...
            if (err.message.toLowerCase().includes("cannot find any free port in range")) {
                console.log(`Cannot find any free port in range. Error message: ${err.message} Appium need restart, exit  code 1 `);
            ...
            if (err.message.toLowerCase().includes("сannot execute the 'am' shell command")) {
                console.log(`- [BaseDriver] Got error: Cannot execute the 'am' shell command. Error message: ${err.message} Appium need restart, exit code 0`);
                // process.exit(0);
            }
