...
function buildHandler(app, method, path, spec, driver, isSessCmd) {
    let asyncHandler = async (req, res) => {
        ...
        try {
            ...
            // Check if the error is related to executing the 'am' shell command
            if (err.message.toLowerCase().includes("Cannot execute the 'am' shell command")) {
                console.log("got error: Cannot execute the 'am' shell command");
                process.exit(0);
            }
