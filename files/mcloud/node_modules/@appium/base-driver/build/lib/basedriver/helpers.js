            ...
            try {
                ...
                if (localAppsFolder != undefined) {
                    ...
                    if (await support_1.fs.exists(localFile)) {
                        ...
                        logger_1.default.info(`[MCLOUD] .lock file parameters. Сreated time: ${(await support_1.fs.stat(lockFile)).ctime.toLocaleString('en-US', { timeZoneName: 'short' })}; device/session details: ${await support_1.fs.readFile(lockFile, 'utf8')}`);
