    ...
    return await APPLICATIONS_CACHE_GUARD.acquire(appCacheKey, async () => {
        if (isUrl) {
            ...
            try {
                ...
                // TODO: !!!!! IMPORTANT
                // This logic is not usable with the latest version of driver. As appium automatically unpacks zip archive which makes it not usable for our customization.
                // Need to find a way of copying .zip file before its unacking and removal
