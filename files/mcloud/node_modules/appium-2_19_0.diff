...
index feb921eac..8af155e93 100644
...
@@ -209,6 +210,60 @@ export class DriverCore<const C extends Constraints, Settings extends StringReco
     return {};
   }
...
index d02ae3b33..556f52730 100644
...
+        logger.info(`[MCLOUD] storeAppInCache(). Deleting files by path: ${cachedFullPath}`);
       ...
       const integrity = {};
@@ -569,6 +733,7 @@ async function unzipApp(zipPath, dstRoot, supportedAppExtensions) {
...
index b38e1c9d3..f79bbd1df 100644
...
index 036a89de3..28af60e26 100644
...
@@ -1021,4 +1027,4 @@ function toCommandNameCacheKey(endpoint, method) {
 }
