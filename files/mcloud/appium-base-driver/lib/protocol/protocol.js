...
import {
  MJSONWP_ELEMENT_KEY, W3C_ELEMENT_KEY, MAX_LOG_BODY_LENGTH, PROTOCOLS,
  DEFAULT_BASE_PATH, IMAGE_ELEMENT_PREFIX,
} from '../constants';
...
function routeConfiguringFunction (driver) {
  ...
  return function addRoutes (app, {basePath = DEFAULT_BASE_PATH, extraMethods = {}}) {
    ...
    const allMethods = Object.assign({}, METHOD_MAP, ...extraMethods);
